...
import org.kurento.module.msdata.MsData;
import org.kurento.module.msdata.KmsShowData;
...
public class ShowDataChannelHandler extends TextWebSocketHandler {
  ...
  private void start(final WebSocketSession session, JsonObject jsonMessage) {
    try {
      ...
      // Media logic
      //MsData msData = new MsData.Builder(pipeline).build();
      KmsShowData msData = new KmsShowData.Builder(pipeline).build();
      webRtcEndpoint.connect(msData);
      msData.connect(webRtcEndpoint);
